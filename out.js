...
var _c_init = Module['_c_init'] = makeInvalidEarlyAccess('_c_init');
var _c_put_piece = Module['_c_put_piece'] = makeInvalidEarlyAccess('_c_put_piece');
var _get_turn = Module['_get_turn'] = makeInvalidEarlyAccess('_get_turn');
var _get_board = Module['_get_board'] = makeInvalidEarlyAccess('_get_board');
var _get_is_end = Module['_get_is_end'] = makeInvalidEarlyAccess('_get_is_end');
var _get_sum_piece = Module['_get_sum_piece'] = makeInvalidEarlyAccess('_get_sum_piece');
var _worker_ai_calc = Module['_worker_ai_calc'] = makeInvalidEarlyAccess('_worker_ai_calc');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['c_init'] != 'undefined', 'missing Wasm export: c_init');
  assert(typeof wasmExports['c_put_piece'] != 'undefined', 'missing Wasm export: c_put_piece');
  assert(typeof wasmExports['get_turn'] != 'undefined', 'missing Wasm export: get_turn');
  assert(typeof wasmExports['get_board'] != 'undefined', 'missing Wasm export: get_board');
  assert(typeof wasmExports['get_is_end'] != 'undefined', 'missing Wasm export: get_is_end');
  assert(typeof wasmExports['get_sum_piece'] != 'undefined', 'missing Wasm export: get_sum_piece');
  assert(typeof wasmExports['worker_ai_calc'] != 'undefined', 'missing Wasm export: worker_ai_calc');
  ...
  _c_init = Module['_c_init'] = createExportWrapper('c_init', wasmExports['c_init'], 0);
  _c_put_piece = Module['_c_put_piece'] = createExportWrapper('c_put_piece', wasmExports['c_put_piece'], 5);
  _get_turn = Module['_get_turn'] = createExportWrapper('get_turn', wasmExports['get_turn'], 0);
  _get_board = Module['_get_board'] = createExportWrapper('get_board', wasmExports['get_board'], 1);
  _get_is_end = Module['_get_is_end'] = createExportWrapper('get_is_end', wasmExports['get_is_end'], 0);
  _get_sum_piece = Module['_get_sum_piece'] = createExportWrapper('get_sum_piece', wasmExports['get_sum_piece'], 1);
  _worker_ai_calc = Module['_worker_ai_calc'] = createExportWrapper('worker_ai_calc', wasmExports['worker_ai_calc'], 4);
  _main = createExportWrapper('main', wasmExports['main'], 2);
